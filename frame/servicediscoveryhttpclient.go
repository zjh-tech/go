...
// func (s *ServiceDiscoveryHttpClient) Init(url string, serverId uint64, token string, cb SDHttpCbFunc) bool {
// 	s.cb = cb
// 	var full_url string
// 	full_url += "http://" + url
